...
final class WOOF_EXT_TPL_1 extends WOOF_EXT {
    ...
    public function draw($products) {
        ...
        if (file_exists($this->get_ext_override_path() . 'views' . DIRECTORY_SEPARATOR . 'output.php')) {
            echo $WOOF->render_html($this->get_ext_override_path() . 'views' . DIRECTORY_SEPARATOR . 'output.php', $data);
        } else {
            echo $WOOF->render_html($this->get_ext_path() . 'views/output.php', $data);
        }
    }
